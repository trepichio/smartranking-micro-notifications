const HTML_NOTIFICATION_ON_NEW_CHALLENGE_TO_RIVAL = `
        ...
        <div style="background: white; border-radius: 3px;">
            <div style="padding: 56px 48px 72px 48px;">
                ...
                <p style="margin: 0; margin-bottom: 56px; font-weight: 400; color: #979e97; font-size: 18px;">
                    You have been challenged by #REQUESTER_NAME#! <br/>
                    Learn more by opening your app.
                </p>
            </div>
        </div>
        <p style="width: 100%; text-align: center; color: #979e9780; font-size: 14px; margin: 0; margin-top: 24px;">
            This is an automatic message, please do not reply this e-mail.
        </p>
    </div>
</body>
`;

export default HTML_NOTIFICATION_ON_NEW_CHALLENGE_TO_RIVAL;
